...
import {
  IonToolbar, IonButton, IonIcon, IonTitle, IonRouterLink, IonNavLink,
} from '@ionic/react';
import {
  add, addOutline, ellipsisHorizontal, ellipsisHorizontalOutline, funnel, funnelOutline, menu, menuOutline, search, searchOutline,
} from 'ionicons/icons';
import './Toolbar.css';
...
const Toolbar:React.FC<ToolbarProps> = ({
  name, search, addScene, filter, elipse,
}) => (
