...
import HighlightedText from '../../descriptive/HighlightedText/HighlightedText';
...
// Interfaz para las opciones de visualización
export interface SceneCardDisplayOptions {
  showHeader: boolean;
...
export const DEFAULT_DISPLAY_OPTIONS: SceneCardDisplayOptions = {
  showHeader: true,
  showSynopsis: true,
  showCharacters: true,
  showExtras: true, 
        ...
        <IonItem className="ion-no-margin ion-no-padding scene-card-item" color={defineSceneColor(scene)}>
          ...
          <IonGrid className="ion-no-margin ion-no-padding" >
            <IonRow className={`scene-card`} onClick={() => goToSceneDetails()}>
              ...
              {(options.showPageInfo || options.showTimeInfo) && (
                <IonCol className="scene-card-col-2">
                  {options.showPageInfo && (
